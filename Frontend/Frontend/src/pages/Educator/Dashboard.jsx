...
function Dashboard() {
  ...
  return (
    <div className='min-h-screen bg-gray-100'>
      ...
      <FaArrowLeftLong
        className="fixed top-4 left-4 w-6 h-6 z-50 cursor-pointer md:top-10 md:left-10"
        onClick={() => navigate("/")}
      />
      ...
      <div className='w-full px-6 py-10 bg-gray-50 space-y-10'>
        ...
        <div className='max-w-5xl mx-auto bg-white rounded-xl shadow-md p-6 flex flex-col md:flex-row items-center gap-6'>
          ...
          <div className='text-center md:text-left space-y-1'>
            ...
            <h1
              className='px-[10px] py-[10px] border-2 bg-black border-black text-white rounded-[10px] text-[15px] cursor-pointer inline-flex justify-center'
