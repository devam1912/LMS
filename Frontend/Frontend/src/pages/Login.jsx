      ...
      <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl rounded-2xl flex relative' onSubmit={(e)=>e.preventDefault()}>
         ...
         <FaArrowLeftLong className='absolute top-[16%] md:top-[6%] left-[5%] w-[22px] h-[22px] cursor-pointer' onClick={()=>navigate("/")}/>
          ...
          <div className='md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-3'>
            ...
            <button className='w-[80%] h-[40px] bg-[black] text-white cursor-pointer flex items-center justify-center justify-center rounded-[5px] cursor-pointer' disabled={loading} onClick={handleLogin}>{loading? <ClipLoader size={30} color='white'/>:"Login"}</button>

            <span className='text-[13px] cursor-pointer text-[#585757]' onClick={()=>navigate("/forgot-password")}>Forgot password ?</span>
            ...
            <div className='w-[80%] h-[40px] border-1 border-[black] rounded-[5px] flex items-center justify-center' onClick={googleLogin}>
              ...
              <span className='text-[18px] text-grey-500'>oogle</span>
            </div>
