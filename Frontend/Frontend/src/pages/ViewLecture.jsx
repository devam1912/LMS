...
function ViewLecture() {
    ...
    <div className='min-h-screen bg-gray-50 p-6 flex flex-col md:flex-row gap-6'>
        ...
        <div className='mb-6 '>
            <h2 className='text-2xl font-bold flex items-center justify-start gap-[20px] text-gray-800'><FaArrowLeftLong className='text-black w-[22px] h-22[px] cursor-pointer' onClick={()=>navigate("/")}/>{selectedCourse?.title}</h2>
