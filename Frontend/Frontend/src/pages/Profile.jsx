      ...
      <FaArrowLeftLong  className='absolute top-[8%] left-[5%] w-[22px] h-[22px] cursor-pointer' onClick={()=>navigate("/")}/>
        ...
        <div className='mt-6 space-y-4'>
          <div className='text-sm flex items-center justify-start gap-1'>
            <span className='font-semibold tex-gray-700'>Email: </span>
            <span>{userData?.email || "-"}</span>
          </div>

          <div className='text-sm flex items-center justify-start gap-1'>
            <span className='font-semibold tex-gray-700'>Bio: </span>
            <span>{userData?.description || "-"}</span>
          </div>

          <div className='text-sm flex items-center justify-start gap-1'>
            <span className='font-semibold tex-gray-700'>Enrolled Courses: </span>
